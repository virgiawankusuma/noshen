    ...
    return (
      <div className="noshen-input">
        ...
        <form className="contact-input" onSubmit={this.onSubmitEventHandler}>
          ...
          <input className="noshen-input__title" type="text" placeholder="Title.." required value={this.state.title} onChange={this.onTitleChangeEventHandler} />
          <textarea className="noshen-input__body" type="text" placeholder="Content.." required spellCheck="false" defaultValue={this.state.body} onChange={this.onContentChangeEventHandler} />
